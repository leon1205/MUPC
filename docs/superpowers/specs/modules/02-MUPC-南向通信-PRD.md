...
> 文档版本：v1.11（2026-09-22）｜状态：**需求评审通过（终审 2026-09-21）**；v1.7 / v1.8 / v1.9 / v1.10 / v1.11 为评审通过后的 **§9 增量补登/订正**（不构成重新评审）｜本轮新增 **§9 站级南向设备语义点表集成（S3b-2）**
>
