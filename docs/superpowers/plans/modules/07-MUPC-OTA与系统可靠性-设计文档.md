...
> 本文档由以下两份已评审设计文档合并而成：
> - `2026-05-28-Phase3C2-OTA模型自动更新-设计文档.md` v1.1 [DESIGN_APPROVED]
> - `2026-05-29-MUPC-固件OTA与系统可靠性-设计文档.md` v1.0 草稿
...
| 源文档 | 对应章节 | 状态 |
|--------|---------|------|
| 2026-05-28-Phase3C2-OTA模型自动更新-设计文档.md v1.1 | 第 2 章（模型 OTA 设计） | [DESIGN_APPROVED] |
| 2026-05-29-MUPC-固件OTA与系统可靠性-设计文档.md v1.0 | 第 1, 3~7 章 | 草稿（待评审） |
